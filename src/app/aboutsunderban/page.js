    ...
    return (
      <div className="acc-page">
        <div className="wrapper">
          ...
          <div>
            <h3>Flora</h3>
            <p>Mangrove ecosystem is a very specialised environment occurring in between the terrestrial habitat and the sea in the tropical and sub-tropical regions. Sundarban is the largest delta formed by the confluence of the Ganges, Brahmaputra and Meghna rivers in the Bay of Bengal.The transitional habitat supports a unique variety of plant community, known as ‘mangrove’. The term ‘mangrove’ is derived from a Portuguese word ‘mangue’, which means salt tolerant plants.Sundarban is the home of more than 300 species of plants,among them some are true mangroves.
            The Sundarbans flora is characterised by the abundance of Sundari (Heritiera fomes), Genwa (Excoecaria agallocha), Goran (Ceriops decandra), Keora (Sonneratia apetala), Kalo Baine(Avicennia alba),Peara Baine (Avicennia marina),Jat Baine(Avicennia officinalis),
            Hental (Phoenix paludosa),Garjan (Rhizophora apiculata),Tora (Aegialitis rotundifolia),Khalsi (Aegiceras corniculatum),Hargoja (Acanthus ilicifolius),Pashur (Xylocarpus mekongensis),Kankra(Bruguiera gymnorrhiza) etc.
            </p>
          </div>
          <div>
            <h3>Fauna</h3>
            <div>
                <p>Sundarban is also the only mangrove forest in the world with an indigenous population of tigers. According to the 2004 census, there are approximately 58 species of mammals, 55 species of reptiles, and approximately 248 bird species in Indian Sundarban.</p>
            </div>
            <div>
                <p>Sundarban has 693 species of wildlife, including 49 mammal species, 59 reptile species, 8 amphibian species, 210 white fish species, 24 shrimp species, 14 crab species, and 43 mollusk species. One of the property’s most appealing features is the 315 species of waterfowl, raptors, and forest birds that can be found there, including nine species of kingfishers and the marvelous white-bellied sea eagle.</p>
            </div>
          </div>
        </div>
      </div>
